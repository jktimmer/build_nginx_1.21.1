...
our %config = (
    ...
    "openssl_sys_defines" => [],
    "openssldir" => "",
    "options" => "--prefix=/home/chen/nginx_builder/build/lib/openssl-3.0.1/.openssl no-acvp-tests no-asan no-asm no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fips no-fips-securitychecks no-fuzz-afl no-fuzz-libfuzzer no-ktls no-loadereng no-md2 no-msan no-rc5 no-sctp no-shared no-ssl3 no-ssl3-method no-tests no-threads no-trace no-ubsan no-unit-test no-uplink no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
    "patch" => "1",
    "perl_archname" => "x86_64-linux-gnu-thread-multi",
    "perl_cmd" => "/usr/bin/perl",
    "perl_version" => "5.30.0",
    "perlargv" => [
        "--prefix=/home/chen/nginx_builder/build/lib/openssl-3.0.1/.openssl",
        "no-shared",
        "no-threads",
        "no-asm",
        "no-tests"
...
unless (caller) {
    ...
    use lib '/home/chen/nginx_builder/build/lib/openssl-3.0.1/util/perl';
    use OpenSSL::fallback '/home/chen/nginx_builder/build/lib/openssl-3.0.1/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/home/chen/nginx_builder/build/lib/openssl-3.0.1/Configurations';
        use gentemplate;
